        ...
        stage('Build Project') {
            steps {
                script {
                    ...
                    bat '"C:\\Program Files (x86)\\Microsoft Visual Studio\\2022\\BuildTools\\MSBuild\\Current\\Bin\\MSBuild.exe" Jenkins-declarativePipeline.csproj /p:Configuration=Release /t:Rebuild'
                }
            }
        }
